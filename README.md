...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/friendly-traceback-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14971&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/friendly-traceback-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `friendly-traceback` can be installed with:

```
conda install friendly-traceback
```

It is possible to list all of the versions of `friendly-traceback` available on your platform with:
